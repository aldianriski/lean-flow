...
| Repo-local `docs/` as system of record, replacing external docs | Exactly the LEAN DOCUMENTATION STANDARD (`STANDARD.md`) — versioned in-repo markdown is already the whole model | reject |
