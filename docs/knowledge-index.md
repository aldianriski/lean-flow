...
- **governance** — [ADR-001](adr/ADR-001-curated-not-copied.md) · [ADR-008](adr/ADR-008-first-code-qa-check.md) · [bmad-adaptation](research/bmad-adaptation.md) · [brainstorming-adaptation](research/brainstorming-adaptation.md) · [init-vs-migrate](research/init-vs-migrate.md) · [structarmed-adaptation](research/structarmed-adaptation.md)
