...
- [EPIC-016](EPIC-016-agentic-governance-dashboard-pilot.md) — Agentic Governance Dashboard Pilot: an operator creates, runs, monitors, decides on and accepts real agent work across two repos **entirely from a dashboard** — **active** 2026-09-09 · `workdoo SPRINT-001`…`SPRINT-007` all **closed**; phase 3 foundations built, its interface next · **P0, the critical path** per the 2026-09-09 roadmap revision, which reprioritises delivery around a usable dashboard and supersedes the prior platform-investment ordering · built in a **separate repository** (`workdoo`) with lean-flow consumed as a pinned plugin ([ADR-041](../adr/ADR-041-platform-repo-service-boundary.md)) · **admissible now** — it inherits no unmet gate, because it deliberately absorbs only *operational subsets* of EPIC-006 · 009 · 010 · 012 and closes none of them (roadmap §10) · member sprints live in `workdoo` and start at its own `SPRINT-001`
- [EPIC-015](EPIC-015-execution-autonomy.md) — Execution Autonomy: an approved Plan runs to a named terminal state without per-task confirmation — proposed 2026-08-24 · **supersedes SPRINT-082's execution-architecture freeze** — ruling now **in force**, written into the gated register 2026-08-24→**amended 2026-08-25** ([`adlc-epic-sequencing.md`](../research/adlc-epic-sequencing.md) § *The core execution architecture is FROZEN*); the freeze re-arms after V3 §56's dogfoods · **admissible now** — its two gates (freeze amendment · sequenced after SPRINT-083) are both met, so it may run as a **second stream alongside EPIC-014**, with `.claude/CONTEXT.md` single-owned at G2 · **no active sprint** — `SPRINT-101` **closed** 2026-09-15 (`c8bc300`) at 11 of 20 DoD, **3 of 8** § Closed-when ticked (re-counted from the epic file at the 2026-09-16 `/triage`; this line previously read "SPRINT-101 active … 4 of 8", both stale — **TD-163**) · § Closed-when 1 has now foreclosed **three times** and its remaining blocker is the gate (**TD-117**, owned by **`TASK-349`**), not the envelope, which is signed and verifying
- [EPIC-014](EPIC-014-reference-engine.md) — Reference Engine: conformance + QA evaluated by a typed TS/Bun implementation, Shell retired — **active** 2026-08-24 · **sequenced ahead of EPIC-005** (owner ruling 2026-08-24) · **2 of 8** § Closed-when ticked · five member sprints closed, newest **SPRINT-092** (2026-08-31) — this line read "SPRINT-083 promoted" until the 2026-09-16 `/triage` (**TD-163**) · **the gap since is sequencing, not drift**: Governance Roadmap § 10 (2026-09-09) rules the engine migration is completed *"sesuai manfaat serta dependensi yang sudah teramati"* — on measured pilot demand — so it waits on EPIC-016's bottleneck report rather than on anyone picking it back up
