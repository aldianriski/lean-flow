...
- [EPIC-006](EPIC-006-run-evidence.md) — Run Evidence: every run leaves machine-readable evidence — proposed 2026-08-23 · re-enters ADR-013 (c) and must supersede it first
- [EPIC-005](EPIC-005-fleet.md) — Fleet: one standard governing N repos — proposed 2026-08-10 · depends on 003 + 004 (both now closed)
