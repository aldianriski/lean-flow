...
# lean-flow — Changelog archive (v1.25.2)

<!-- Rotated verbatim from root CHANGELOG.md at the SPRINT-049 promote (v1.27.0 + v1.26.0 stay inline). Append-only; never edited. -->
