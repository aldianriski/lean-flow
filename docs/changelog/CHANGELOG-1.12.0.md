...
# lean-flow — Changelog archive (v1.10.0 – v1.12.0)

> Rotated out of `docs/CHANGELOG.md` at the SPRINT-028 promote (§11 retention). Verbatim; newest first.
> The v1.12.0 / v1.11.0 `## v` headings had been lost in the inline file (blocks sat fused under
> v1.13.0's heading) — restored here from the release commits (2eb9bd5 · 6df0652).
> Older still → [`CHANGELOG-1.9.0.md`](CHANGELOG-1.9.0.md).
