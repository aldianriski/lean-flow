...
# lean-flow — Changelog archive (v1.17.0 – v1.19.0 era)

<!-- Rotated verbatim from docs/CHANGELOG.md at the v1.21.0 MINOR (§11). Never edit past blocks. -->
...
_Older releases (**v1.16.1** and earlier) → [`CHANGELOG-1.16.1.md`](CHANGELOG-1.16.1.md)._
