...
- related: L-058 (must-FAIL fixtures — what caught two of the three) · L-091 (re-derive before building on a stated cure) · L-109 (its sibling trap in the same assertion) · L-105 (the temporal sibling it now sits beside)
