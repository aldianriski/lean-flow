...
- count: 1
- promoted: no
- related: L-108 (the rule that did not fire; count 4) · L-099 (a rule its reader cannot read) · L-105 (correct rule, wrong moment) · L-058 (the silent false negative this produces) · TASK-200
...
- related: L-058 (must-FAIL fixtures — what caught two of the three) · L-091 (re-derive before building on a stated cure) · L-109 (its sibling trap in the same assertion) · L-105 (the temporal sibling it now sits beside) · L-099 (a rule its reader does not read — the fourth sighting's shape)
