...
// was `evals/run-adr-family-fixtures.sh`, which spawns the Shell engine 12 times and costs 30.0 s.
...
import { evaluate as evaluateOnefile } from "../packages/standard/src/rules/s4-onefile.ts";
import { evaluate as evaluateIndex } from "../packages/standard/src/rules/s4-index.ts";
import { evaluate as evaluateSections } from "../packages/standard/src/rules/s4-sections.ts";
import { evaluate as evaluateNegative } from "../packages/standard/src/rules/s4-negative.ts";
